        ...
        <div>
            ...
            {!loading && (
                ...
                <div className='flex gap-6 py-18 flex-wrap justify-around'>
                    {items.map((item) => {
                        return (
                            <div key={item.id} className='flex flex-col justify-around rounded-md items-center h-auto w-64 bg-transparent border-2 border-sky-400 p-3 shadow-[0_4px_10px_rgba(0,0,0,0.8)]'>
